  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        <div className={`grid grid-cols-1 ${isSidebarOpen ? 'lg:grid-cols-3' : 'lg:grid-cols-1'} gap-6`}>
          <div className={`${isSidebarOpen ? 'lg:col-span-2' : 'lg:max-w-4xl lg:mx-auto lg:w-full'}`}>
