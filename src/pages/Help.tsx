          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="getting-started">
              ...
              <AccordionContent className="text-muted-foreground">
                ...
                <p>
                  Our editor supports multiple Indian languages and has built-in tools for
                  formatting.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="multilingual">
              ...
              <AccordionContent className="text-muted-foreground">
                ...
                <p>
                  Currently, we support Hindi, Bengali, Tamil, Telugu, Marathi, Gujarati, Kannada,
                  Malayalam, Punjabi, and English.
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
