    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <section className="mb-8 prose lg:prose-xl">
          ...
          <p className="mb-4">
            At WriteSpace, we take your privacy seriously. This Privacy Policy explains how we collect,
          ...
          <p className="mb-4">
            ...
            employed by websites linked to or from our site.
          </p>
          ...
          <p className="mb-4">
            WriteSpace has the discretion to update this privacy policy at any time. When we do,
            we will revise the updated date at the top of this page. We encourage users to frequently
