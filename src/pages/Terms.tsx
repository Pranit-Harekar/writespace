    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <section className="mb-8 prose lg:prose-xl">
          ...
          <p className="mb-4">
            By accessing or using WriteSpace, you agree to be bound by these Terms of Service and
          ...
          <p className="mb-3">
            Permission is granted to temporarily access the materials on WriteSpace's website for
          ...
          <p className="mb-4">
            ...
            may be terminated by WriteSpace at any time.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">3. User Content</h2>
          <p className="mb-4">
            Our service allows you to post, link, store, share and otherwise make available certain
            information, text, graphics, videos, or other material ("Content"). By posting Content
            on WriteSpace, you grant us the right to display, reproduce, and distribute your
            Content. You retain any and all of your rights to any Content you submit, post or
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              Infringes upon or violates any third party's intellectual property or other rights;
            </li>
            <li>
              Contains software viruses or any other computer code designed to interrupt, destroy,
              or limit the functionality of any computer software or hardware;
            </li>
            <li>
              Constitutes unauthorized or unsolicited advertising, spam or bulk e-mail ("spamming");
            </li>
          ...
          <p className="mb-4">
            In no event shall WriteSpace, nor its directors, employees, partners, agents, suppliers,
